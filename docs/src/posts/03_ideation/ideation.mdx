...
Based on this prototype we also made a storyboard to describe the user scenario of the app (see figure FIXME).

![Storyboard interaction scenario](./img/storyboard.png)

# Activity Diagram

Based on the Figma wireframe, we made an activity diagram to transform our ideas into a real app structure. You can see this activity diagram in figure FIXME.
