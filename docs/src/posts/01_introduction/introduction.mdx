...
> The operator need a clear overview of the requests, whether it is already approved and/or payed. For the operator this overview is most likely a webpage replacing the excel documents used now.
...
![Anki Vector Squinting his eyes](./img/vector.gif)
