...
We set up two tests, one with the operators at Digital Fabrication Lab for the web page and one with 5 students to test the app. The test results can be found in the appendices.
